...
export default function CruisePlans() {
  ...
  return (
    <section id="cruise-plans" className="relative py-16 md:py-24 lg:py-32 px-6 lg:px-14" style={{ background: "#0d1b2a" }}>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        {/* Header */}
        <div className="mb-12">
          <p className="text-[12px] tracking-[0.25em] uppercase mb-4 font-manrope font-medium" style={{ color: "rgba(255,255,255,0.4)" }}>
            {lang === "de" ? "Angebote 2026" : "Plans 2026"}
          </p>
          <h2 className="font-manrope font-bold leading-tight" style={{ fontSize: "clamp(2.5rem, 3.2vw, 3.75rem)", color: "#fff" }}>
            CRUISE PLAN
          </h2>
        </div>

        {/* Tabs */}
        <div className="flex gap-0 mb-12" style={{ borderBottom: "1px solid rgba(255,255,255,0.1)" }}>
          {PLANS.map((p, i) => (
            <button
              key={p.key}
              onClick={() => setActive(i)}
          ...
          >
            <div className="flex-1">
              <span
                ...
                style={{ background: "rgba(74,127,181,0.15)", color: "#4a7fb5", borderRadius: "4px" }}
              >
                {lang === "de" ? plan.tagDe : plan.tagEn}
              </span>

              <h3 className="font-manrope font-bold mb-4" style={{ fontSize: "1.6rem", color: "#fff" }}>
                {lang === "de" ? plan.labelDe : plan.labelEn}
              </h3>

              <p className="font-manrope font-light text-base leading-relaxed mb-8" style={{ color: "rgba(255,255,255,0.55)" }}>
            ...
            <div
              ...
              style={{ minHeight: "200px", background: "rgba(255,255,255,0.03)", border: "1px dashed rgba(255,255,255,0.1)" }}
            >
              <p className="font-manrope text-[12px] tracking-[0.15em] uppercase text-center" style={{ color: "rgba(255,255,255,0.2)" }}>
